...
namespace WardrobeMVC.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        {
            var outfits = db.Outfits.Include(o => o.Accessory).Include(o => o.Bottom).Include(o => o.Footwear).Include(o => o.Top);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.FootwearID = new SelectList(db.Footwears, "FootwearID", "FootwearName");
        ...
        public ActionResult Create([Bind(Include = "OutfitID,TopID,BottomID,FootwearID,AccessoryID")] Outfit outfit)
        {
            ...
            ViewBag.FootwearID = new SelectList(db.Footwears, "FootwearID", "FootwearName", outfit.FootwearID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,TopID,BottomID,FootwearID,AccessoryID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
